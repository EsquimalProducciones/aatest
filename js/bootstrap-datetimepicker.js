...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		place: function () {
			...
			this.picker.removeClass('datetimepicker-dropdown-modalResponsive');
		
			if(this.pickerPosition == "modalResponsive"){
						
				var wSize = $(window).width();
					if (wSize <= 768) {
						var topResponsive = '25%';
						var leftResponsive = '15px';
						...
						if (!target.is('.disabled')) {
							...
							if (target.is('.month')) {
								...
								if (this.viewSelect >= 1) {
									this._setDate(UTCDate(year, month, day, hours, minutes, 0 , 0));
								}
